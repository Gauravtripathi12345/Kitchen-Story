...
namespace KitchenStoryProject.Controllers
{
    public class FoodItemController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            try
            {
                FoodMaster foodMaster = foodItemDal.GetFoodItemById(id.Value);
                if (foodMaster != null)
                {
                    FoodItemModel foodItemModel = new FoodItemModel()
                    {
        ...
        {
            FoodMaster foodMaster = foodItemDal.GetFoodItemById(id);
            FoodItemModel foodItemModel = new FoodItemModel()
            {
                Id = foodMaster.Id,
                FoodName = foodMaster.FoodName,
        ...
        {
            foodItemsList = foodItemDal.GetAllFoodItem();
            FoodMaster foodItem = foodItemsList.Find(f => f.Id == id);
